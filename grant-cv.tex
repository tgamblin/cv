...
\renewcommand{\bibliographyitemlabel}{
	\ifthenelse{\value{enumiv}=43\or%
				\value{enumiv}=53}{\color{color1}\textbf{Best Poster} \color{black}}{}
...
\small{
	\nocite{laguna+:pact12,sato+:sc12,bhatele+:sc12-samrai,bhatele+:sc12-rubik,landge+:infovis12,pearce+:ics12,laguna+:sc11,szebenyi+:ipdps11,gamblin+:ics10,gamblin+:sc08}
