...
\newcommand{\github}[1]{\href{https://github.com/scalability-llnl/#1}{#1}}
...
\usepackage{multibib}
\newcommand{\paperSecTitle}   {\bibsectiontitleformat{%
...
\newcommand{\bookSecTitle}    {\bibsectiontitleformat{Special Journal Issues}}
...
\section{Selected Publications}
	\nocitePaper{*}
	\bibliographystylePaper{plain-url-inline-revchron-nohighlight}
...
%	\nociteWorkshop{*}
%	\bibliographystyleWorkshop{plain-url-inline-revchron-nohighlight}
%	\bibliographyWorkshop{Bibliographies/Workshops}

	\nociteBook{gamblin+tallent:parco-whist}
%		,gamblin:comp-annual-report10
%		,fowler+:cetraro07
	\bibliographystyleBook{plain-url-inline-revchron-nohighlight}
	\bibliographyBook{Bibliographies/Books}

	\nocitePhD{*}
	\bibliographystylePhD{plain-url-inline-revchron-nohighlight}
	\bibliographyPhD{Bibliographies/PhD}

%	\nocitePoster{*}
%	\bibliographystylePoster{plain-url-inline-revchron-nohighlight}
%	\bibliographyPoster{Bibliographies/Posters}
	\subsection{Other Papers, Presentations, \& Articles}
	\cvitem{}{
		13 peer-reviewed workshop papers and technical reports.
		2 Book Chapters.\newline
		20 significant posters and presentations.
